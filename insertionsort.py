...
#we shall be interested in the average-case running time of an algorithm; probabilistic analysis , randomized algorithm, which makes random choices, to allow a probabilistic analysis and yield an expected running time. 
